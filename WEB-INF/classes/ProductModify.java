	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='phones' selected>Phone</option><option value='laptops'>Laptop</option><option value='wts'>WearableTech</option>option value='vas'>VoiceAsst</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
