	...
	protected void review(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     utility.printHtml("header.html");
		...
		pw.print("</h2><div class='entry'>");
                pw.print("<table class='gridtable' style='margin-bottom:23px'>");
		...
		pw.print("<input type='hidden' name='productmaker' value='"+productmaker+"'>");
                pw.print("</td></tr><table>");
  				...
  				pw.print("<table><tr></tr><tr></tr><tr><td style='font-size:medium'> Review Rating: </td>");
					pw.print("<td>");
					...
					pw.print("<tr>");
					pw.print("<td style='font-size:medium'> UserID: </td>");
					pw.print("<td> <input type='text' name='userid'> </td>");
			        pw.print("</tr>");	

			        pw.print("<tr>");
					pw.print("<td style='font-size:medium'> User Age and Occupation: </td>");
					pw.print("<td> <input type='text' name='userage'> </td>");
			        pw.print("</tr>");	

					pw.print("<tr>");
					pw.print("<td style='font-size:medium'> Retailer Zip Code: </td>");
					pw.print("<td> <input type='text' name='zipcode'> </td>");
			        pw.print("</tr>");		


					pw.print("<tr>");
					pw.print("<td style='font-size:medium'> Retailer City: </td>");
					pw.print("<td> <input type='text' name='retailercity'> </td>");
			        pw.print("</tr>");							
		
				pw.print("<tr>");
					pw.print("<td style='font-size:medium'> Review Date: </td>");
					pw.print("<td> <input type='date' name='reviewdate'> </td>");
			       pw.print("</tr>");				

				pw.print("<tr>");
					pw.print("<td style='font-size:medium'> Review Text: </td>");
					pw.print("<td><textarea name='reviewtext' rows='4' cols='50'> </textarea></td></tr>");
				pw.print("<tr><td colspan='2'><input type='submit' class='btnbuy' name='SubmitReview' value='SubmitReview' style='margin-top:37px; margin-left:197'></td></tr></table>");
